...
<head>
    ...
    @section('social-meta')
        ...
        <meta property="og:image" content="https://static.vecteezy.com/system/resources/previews/000/380/631/non_2x/eye-dollar-vector-icon.jpg">
    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="{{ route('create_ad') }}"> <i class="fa fa-tag"></i> @lang('app.post_an_ad')
                  <small>@lang('app.post_an_ad_small')</small>
                </a></li>
                @endif
                    ...
                    @if(get_option('enable_language_switcher') == 1)
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="{{ route('switch_language', 'eng') }}">English</a></li>

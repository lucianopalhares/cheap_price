...
<table class="table table-hover">
  <thead>
    <tr>
      ...
      <th scope="col">{{trans('validation.attributes.abbrev')}}</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{{$item->slug}}</td>
      <td>
        <a href="{{url('admin/measure/'.$item->id.'/edit')}}" class="text-primary"><span data-feather="edit"></span></a>
  ...
  jQuery(document).ready(function(){
    ...
    $("a#delete_item").click(function(e){
        ...
        if (confirm("{{trans('app.are_you_sure')}}")) {
          ...
          $.ajax({
            url: "measure/"+id, //or you can use url: "company/"+id,
            type: 'DELETE',
            dataType: "json",
            data: {
              _token: token,

...
return [
    ...
    */
    ...
    'min' => [
        ...
        'string' => 'O(a) :attribute deve ter pelo menos :min caracteres.',
        'array' => 'O(a) :attribute deve ter pelo menos :min items.',
    ],
    'not_in' => 'The selected :attribute is invalid.',
    'not_regex' => 'The :attribute format is invalid.',
    'numeric' => 'O(a) :attribute deve ser um numero.',
    ...
    'size' => [
        'numeric' => 'O(a) :attribute deve ter :size.',
        'file' => 'O(a) :attribute deve ter :size kilobytes.',
        'string' => 'O(a) :attribute deve ter :size caracteres.',
        'array' => 'O(a) :attribute deve conter :size items.',
    ],
    'starts_with' => 'The :attribute must start with one of the following: :values',
    'string' => 'The :attribute must be a string.',
    'timezone' => 'The :attribute must be a valid zone.',
    'unique' => 'O(a) :attribute já existe.',
    'uploaded' => 'O(a) :attribute falhou no upload.',
